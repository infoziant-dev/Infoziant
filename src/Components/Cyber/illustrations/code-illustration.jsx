  ...
  return (
    <div className="w-full h-full flex items-center justify-center">
      <div className="relative w-full max-w-[320px]">
        ...
        {/* Floating Labels */}
        <div
          className={`absolute -top-4 -right-4 bg-blue-500 text-white text-xs px-2 py-1 rounded transition-all duration-700 ${
        ...
        <div
          className={`absolute -bottom-4 -left-4 bg-orange-500 text-white text-xs px-2 py-1 rounded transition-all duration-700 ${
            animate ? "translate-y-2" : ""
          }`}
        >
          HTML
        ...
        <div
          className={`absolute top-1/2 -left-6 -translate-y-1/2 bg-teal-500 text-white text-xs px-2 py-1 rounded transition-all duration-700 ${
