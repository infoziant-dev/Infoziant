    ...
    <Router>
      ...
      <Loader fetchData={fetchData}>
        ...
        <Routes>
          ...
          <Route
            path="/services/cybersecurity/vapt/network-infrastructure"
            element={<NetworkInfrastructure />}
          />
          <Route
            path="/services/cybersecurity/vapt/web-and-mobile-app"
            element={<WebAndMobile />}
          />
          <Route
            path="/services/cybersecurity/vapt/cloud-infrastructure"
            element={<CloudInfrastructure />}
          />
          <Route
            path="/services/cybersecurity/vapt/api-vapt"
            element={<ApiVapt />}
          />
